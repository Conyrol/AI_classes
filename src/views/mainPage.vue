            ...
            <div class = "item-main">
              <div class = "flexDiv_col2" :style = "{'height': '100%'}">
                <div class = "flexDiv_row" :style = "{'height': '85%'}">
                  <div class = "main-image" :style = "{'width': '700px', 'height': '100%'}"></div>
    ...
    data () {
      return {
        data_list_now: [{
          ...
          tags: ["科普", "基础", "DL", "ML"],
          title: "人工智能真有这么有趣？",
          content: "这没有什么智械危机，也没有什么哲学伦理探讨，更不会有晦涩难懂的公式推导(或许会有?)，只有一个个有趣且简单的项目，如果你问我人工智能真能有这么有趣？那我只能说是的。但是人工智能实在是太广了，这个兴趣开放课程只会带你领略他的冰山一角(CV方向)，但如果你跟着完成了以下的任务，那么你一定会对人工智能有一个初步的了解，并且能上手属于自己的项目。",
          img_src: '',
          article_src: '',
          ddl_date: [],
        ...
        {
          index: 1,
          tags: ["环境配置", "基础", "python", "anaconda"],
          title: "学习人工智能的工具",
          type: 0,
          img_src: '',
          article_src: '',
          content: "行行都有自己的工具，人工智能也不例外。不过谢天谢地，人工智能一般只需要掌握一个工具就能使出18般武艺了，这个工具叫做 python。那么第一个需要上手且有可恶的DDL的任务就来了，这个任务将会引导你配置环境，并运行一份小项目来确认环境配置的正确性。",
          ddl_date: ['2021', '3', '21'],
          create_date: ['2021', '3', '15'],
        },
        {
          index: 2,
          tags: ["实验", "基础", "DL", "全连接网络(FC)"],
          title: "一切的开始：解构和复现一个简单的神经网络",
          type: 0,
          img_src: '',
          article_src: '',
          content: "万事开头难！这个实验将会梳理机器学习和深度学习的基本思路，并使用深度学习中最常见的全连接网络(FC)，做出一些简单的效果，你可以尝试拆分和修改demo项目中的代码，来完成我们布置的一个小任务，代码量不多，而且在实验进行过程中有什么困难会开设答疑会的。",
          ddl_date: ['2021', '3', '28'],
          create_date: ['2021', '3', '22'],
        },
        {
          index: 3,
          tags: ["科普", "基础", "CV相关", "分类任务", "目标检测", "图像生成"],
          title: "五彩缤纷的图像任务",
          type: 1,
          img_src: '',
          article_src: '',
        ...
        {
          index: 4,
          tags: ["实验", "普通难度", "图像分类", "卷积网络"],
          title: "图像分类，从全连接到卷积",
          type: 0,
          img_src: '',
          article_src: '',
          content: "图像分类任务在日常生活中数不胜数，比如说群聊中判断一个图是否是色图，又或是鉴别一张图片拍摄的是什么东西，可以说这个任务无处不在，而有了深度学习，你就可以全自动的让网络帮你做这件事。这个实验将使用最传统的CIFAR-10数据集作为demo完成全连接到卷积的过渡，最后实验会有一个我在网上爬取的数据集，你可以试试你的网络在这个数据集上的训练效果，如果效果不是很好，你可以思考一下怎么优化。",
          ddl_date: ['2021', '4', '04'],
          create_date: ['2021', '3', '29'],
        },
        {
          index: '4+',
          tags: ["实验", "稍有难度", "图像分类", "网络优化", "resnet"],
        ...
        {
          index: '5',
          tags: ["实验", "有难度", "目标检测", "yoloV1", "yoloV3"],
